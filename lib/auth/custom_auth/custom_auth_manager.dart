...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    lincolnEAmigosAuthUserSubject.add(
      LincolnEAmigosAuthUser(loggedIn: false),
    );
  ...
  Future<LincolnEAmigosAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Future<LincolnEAmigosAuthUser?> _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LincolnEAmigosAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    lincolnEAmigosAuthUserSubject.add(updatedUser);
...
LincolnEAmigosAuthUser? currentUser;
